...
public class Topic_07_Login {
    ...
    public void TC_02_Invalid_Email() {
        ...
        driver.findElement(By.cssSelector("div.footer a[title='My Account']")).click();
        driver.findElement(By.cssSelector("input#email")).sendKeys("123123@123");
    ...
    @Test
    public void TC_04_Incorrect_Email_Password() throws InterruptedException {
        driver.get("https://live.techpanda.org/");
        ...
        Assert.assertEquals(driver.findElement(By.cssSelector("li.error-msg"))
